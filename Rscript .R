...
Heart_Attack <- read_csv("Heart Attack Data Set.csv")
View(Heart_Attack)
nrow(Heart_Attack)
ncol(Heart_Attack)
...
# Scatter plots to visualize relationships (example with age vs. cholesterol)
ggplot(Heart_Attack, aes(x = age, y = chol)) +
